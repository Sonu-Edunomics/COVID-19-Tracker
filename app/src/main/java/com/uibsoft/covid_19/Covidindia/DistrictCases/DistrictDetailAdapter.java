package com.uibsoft.covid_19.Covidindia.DistrictCases;
...
public class DistrictDetailAdapter extends RecyclerView.Adapter<DistrictDetailAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public DistrictDetailAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull DistrictDetailAdapter.ViewHolder holder, final int position) {
