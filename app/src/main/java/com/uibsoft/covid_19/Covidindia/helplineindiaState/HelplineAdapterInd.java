...
public class HelplineAdapterInd extends RecyclerView.Adapter<HelplineAdapterInd.ViewHolder>  {
    ...
    @NonNull
    @Override
    public HelplineAdapterInd.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull HelplineAdapterInd.ViewHolder holder, int position) {
