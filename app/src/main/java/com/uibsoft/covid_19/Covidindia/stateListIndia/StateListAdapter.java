package com.uibsoft.covid_19.Covidindia.stateListIndia;
...
import com.uibsoft.covid_19.Covidindia.fragIndia.CityCases;
...
public class StateListAdapter extends RecyclerView.Adapter<StateListAdapter.ViewHolder> {
    ...
    @Override
    public void onBindViewHolder(@NonNull StateListAdapter.ViewHolder holder, final int position) {
